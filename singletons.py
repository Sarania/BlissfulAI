...
class AI(metaclass=SingletonMeta):
    ...
    def reset(self):
        ...
        """
        self.personality_definition = {"name": "Name", "top_p": 1.0, "top_k": 50, "temperature": 1.0, "response_length": 128, "persistent": True, "stm_size": 24, "ltm_size": 24, "repetition_penalty": 1.0, "length_penalty": 1.0, "num_beams": 1, "num_keywords": 3, "top_p_enable": False, "top_k_enable": False, "typical_p": 1.0, "typical_p_enable": False, "temperature_enable": False, "length_penalty_enable": False, "repetition_penalty_enable": False}
        self.core_memory = []
        self.working_memory = []
        self.system_memory = []
        self.num_sys_msg = 0
